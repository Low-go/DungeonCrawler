...
class Level:
    ...
    def create_map(self):
        layouts = {
             'boundary': import_csv_layout("E:\projects\Dungeon\Map\map._border.csv"),
             #'grass': import_csv_layout("E:\projects\zeldaPython\map\map_grass.csv"),
             #'object': import_csv_layout("E:\projects\zeldaPython\map\map_objects.csv")
        }
        graphics = {
            #'grass': import_folder("E:\projects\zeldaPython\graphics\import_folders\grass"),
            #'objects': import_folder("E:\projects\zeldaPython\graphics\import_folders\objects")
        }
...
class YSortCameraGroup(pygame.sprite.Group):   # remember this is how python does inheritance
    def __init__(self):
        ...
        self.floor_surface = pygame.image.load("E:\projects\Dungeon\Map\map.png").convert()
